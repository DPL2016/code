...
<div class="container">
    ...
    <a href="/book/new.action" class="btn btn-success">添加书籍</a>
    <table class="table">
        <thead>
        <tr>
            <th>名称</th>
...
<script src="/ropo/js/jquery-2.2.3.min.js"></script>
<script src="/ropo/js/jquery.twbsPagination.min.js"></script>
<script>
    $(function () {
